...
| **scheduled-notifications** — relances factures (J-3/J0/J+7/J+14) & rappels tournage (J-7/J-1) | quotidien | appelle `notify-client` (`invoice_reminder`, `shoot_reminder`) | ⚠️ fonction **absente du repo** — à rapatrier |
...
- **scheduled-notifications** : son code source n'est nulle part dans le
  repo. À extraire du déploiement (`supabase functions download
  scheduled-notifications`) et committer sous `supabase/functions/`.
